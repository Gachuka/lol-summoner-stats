...
const MatchCardTEST = React.forwardRef(({ matchData, summonerName, versionNumber }, ref) => {
  ...
  return (
    <article className="article" ref={hasRef}>
