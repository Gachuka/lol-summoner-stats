...
function ParticipantsComponent({versionNumber, summonerName, championName}) {
  ...
  return (
    <Link to={`/summoner/${summonerName}`} className='team__summoner summoner'>
      <img className='champion-icon' src={`http://ddragon.leagueoflegends.com/cdn/${versionNumber}/img/champion/${championName === "FiddleSticks" ? "Fiddlesticks": championName}.png`} alt={championName}></img>
